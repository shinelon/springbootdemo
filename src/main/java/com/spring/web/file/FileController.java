...
public class FileController extends BaseController {
	...
	public
	@ResponseBody
	List<FileObject> list(@RequestParam(value = "path", required = false, defaultValue = "D:/file") String path) {
	...
	public
	@ResponseBody
	FileObject upload(@RequestParam(value = "path", required = false, defaultValue = "D:/file") String path,
	...
	public
	@ResponseBody
	boolean upload(@RequestParam(value = "path", required = false, defaultValue = "D:/file") String path,
